hacer el venv en la carpeta de backend que viene siendo toda la logica, esta esta trabajando con django, contando con un total de 2 app aparte de la principal de django que es directory
